<kamakepar></kamakepar><!DOCTYPE html>
<html>
<head>
	<title>Home | Cloud Covid 19</title>
	<meta content="width=device-width, initial-scale=1.0" name="viewport" >
	<link rel="image_src" href="coronavirus.jpg">
	<link rel="stylesheet" href="http://covid19-official.tk/css/bootstrap.min.css" type="text/css" />
...
<div id="flexbox">
<div id="uploading">
<form action="upload.php" id="forming" method="post" multiple enctype="multipart/form-data">
    <br>
    <img src="upload.jpeg" style="border-radius:50%;width:120px; height:120px; align-self:center;"><br>
    ...
    <br>
    <input id="butt" type="submit" value="Upload File" name="submit">
    <br>
